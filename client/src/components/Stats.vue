                ...
                <div class="row align-items-md-stretch">
                    <div class="col-md-6">
                        <div class="h-100 p-5 bg-light border rounded-3">
                            ...
                            <p>Manage the users and posts in your community</p>
                            <button class="btn btn-secondary" type="button"><a href="/" class="text-decoration-none text-white">Go there now</a></button>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="h-100 p-5 bg-light border rounded-3">
